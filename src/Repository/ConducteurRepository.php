 ...
 */
class ConducteurRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function add(Conducteur $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Conducteur $entity, bool $flush = true): void
    {
