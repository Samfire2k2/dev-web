 ...
 */
class PassagerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function add(Passager $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Passager $entity, bool $flush = true): void
    {
